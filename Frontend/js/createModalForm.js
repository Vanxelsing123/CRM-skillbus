...
export const createClientsForm = () => {
    ...
    const unacceptabletter = document.createElement('span');
    ...
    unacceptabletter.id = 'unacceptabletter';
    ...
    errorBlock.append(writeName, writeSurname, writeLastName, requiredValue, unacceptabletter, requiredContacts);
    form.append(
        formFloatingName,
        formFloatingSurname,
